...
const d = {
  ...
  , D = s=>[d.prefix, s, d.suffix].filter(e=>e && e.length > 0).join("-")
  , X = s=>{
...
class he {
    ...
    async cachePut(e, t) {
        ...
        const {cacheName: i, matchOptions: c} = this._strategy
          ...
          , m = h ? await re(o, a.clone(), ["__WB_REVISION__"], c) : null;
        try {
            await o.put(a, h ? r.clone() : r)
        } catch (u) {
            if (u instanceof Error)
                throw u.name === "QuotaExceededError" && await ce(),
                u
        }
...
class N {
    constructor(e={}) {
        this.cacheName = b.getRuntimeName(e.cacheName),
...
class p extends N {
    constructor(e={}) {
        e.cacheName = b.getPrecacheName(e.cacheName),
        super(e),
    ...
    async _handleFetch(e, t) {
        ...
        if (this._fallbackToNetwork) {
            ...
            r && c && e.mode !== "no-cors" && (this._useDefaultCacheabilityPluginIfNeeded(),
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
        ...
        for (const [n,a] of this.plugins.entries())
            a !== p.copyRedirectedCacheableResponsesPlugin && (a === p.defaultPrecacheCacheabilityPlugin && (e = n),
            a.cacheWillUpdate && t++);
...
class le {
    ...
    addToCacheList(e) {
        ...
        for (const n of e) {
            ...
            if (this._urlsToCacheKeys.set(r, a),
        ...
        self.addEventListener("message", e=>{
            if (e.data && e.data.type === "CACHE_URLS") {
                const {payload: t} = e.data
                  , n = Promise.all(t.urlsToCache.map(a=>{
                    typeof a == "string" && (a = [a]);
...
const ye = "-precache-"
  , _e = async(s,e=ye)=>{
    ...
    return await Promise.all(n.map(a=>self.caches.delete(a))),
    n
}
;
function Re() {
...
class Ue extends N {
    constructor(e={}) {
        super(e),
        this.plugins.some(t=>"cacheWillUpdate"in t) || this.plugins.unshift(Le)
    }
    async _handle(e, t) {
...
class Te {
    ...
    isResponseCacheable(e) {
        ...
        this._headers && t && (t = Object.keys(this._headers).some(n=>e.headers.get(n) === this._headers[n])),
        t
    }
}
class q {
    constructor(e) {
        ...
        this._cacheableResponse = new Te(e)
    }
}
function V(s) {
    s.then(()=>{}
...
const Pe = (s,e)=>e.some(t=>s instanceof t);
let v, W;
function ke() {
...
function Ne(s) {
    const e = new Promise((t,n)=>{
        const a = ()=>{
            s.removeEventListener("success", r),
...
function Ke(s) {
    return s === IDBDatabase.prototype.transaction && !("objectStoreNames"in IDBTransaction.prototype) ? function(e, ...t) {
        ...
        return G.set(n, e.sort ? e.sort() : [e]),
        f(n)
    }
    : Ie().includes(s) ? function(...e) {
        return s.apply(T(this), e),
        f($.get(this))
    }
    : function(...e) {
...
function Oe(s) {
    return typeof s == "function" ? Ke(s) : (s instanceof IDBTransaction && Me(s),
    Pe(s, ke()) ? new Proxy(s,I) : s)
}
function f(s) {
    ...
    if (U.has(s))
        return U.get(s);
    const e = Oe(s);
    return e !== s && (U.set(s, e),
    A.set(e, s)),
    e
}
const T = s=>A.get(s);
function Se(s, e, {blocked: t, upgrade: n, blocking: a, terminated: r}={}) {
    ...
    c.then(o=>{
        ...
        a && o.addEventListener("versionchange", h=>a(h.oldVersion, h.newVersion, h))
    }
    ).catch(()=>{}
    ),
    c
...
function ve(s, {blocked: e}={}) {
    ...
    return e && t.addEventListener("blocked", n=>e(n.oldVersion, n)),
    f(t).then(()=>{}
    )
}
const We = ["get", "getKey", "getAll", "getAllKeys", "count"]
...
function B(s, e) {
    ...
    const t = e.replace(/FromIndex$/, "")
      , n = e !== t
      , a = Be.includes(t);
    if (!(t in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || We.includes(t)))
        return;
    const r = async function(i, ...c) {
        const o = this.transaction(i, a ? "readwrite" : "readonly");
        let h = o.store;
        return n && (h = h.index(c.shift())),
...
class Fe {
    ...
    _upgradeDbAndDeleteOldDbs(e) {
        this._upgradeDb(e),
        this._cacheName && ve(this._cacheName)
    }
    ...
    async expireEntries(e, t) {
        ...
        let a = await n.transaction(R).store.index("timestamp").openCursor(null, "prev");
        const r = [];
        let i = 0;
        for (; a; ) {
            const o = a.value;
            o.cacheName === this._cacheName && (e && o.timestamp < e || t && i >= t ? r.push(a.value) : i++),
            a = await a.continue()
        }
        const c = [];
        for (const o of r)
            await n.delete(R, o.id),
            c.push(o.url);
        return c
    }
    _getId(e) {
    ...
    async getDb() {
        return this._db || (this._db = await Se(je, 1, {
...
class Ve {
    constructor(e={}) {
        ...
        this.cacheDidUpdate = async({cacheName: t, request: n})=>{
            ...
            await a.updateTimestamp(n.url),
            await a.expireEntries()
        }
        ,
        this._config = e,
        this._maxAgeSeconds = e.maxAgeSeconds,
        this._cacheExpirations = new Map,
        e.purgeOnQuotaError && qe(()=>this.deleteCacheAndMetadata())
    }
    _getCacheExpiration(e) {
        if (e === b.getRuntimeName())
            throw new l("expire-custom-caches-only");
        let t = this._cacheExpirations.get(e);
        return t || (t = new He(e,this._config),
...
xe([{
    "revision": null,
    "url": "assets/index-1dc749ba.css"
}, {
    "revision": null,
    "url": "assets/index-29dab197.css"
}, {
    "revision": null,
    "url": "assets/index-3a8b3b00.js"
}, {
    "revision": null,
    "url": "assets/index-63d32cbb.js"
}, {
    "revision": "18bd31f4fcc9ccffa524516977fa131f",
    "url": "compose.html"
}, {
    "revision": "49bf6841acf39fa6dbe629b1ef454fc4",
    "url": "index.html"
}, {
    "revision": "faf7881af632ddc1bc816df3c7615d70",
    "url": "js/bing/chat/amd.js"
}, {
    "revision": "acd5d5c6a92b255ad088d78494b9d5d7",
    "url": "js/bing/chat/config.js"
}, {
    "revision": "bf59a711c4cc50c15c4721674ee177bd",
    "url": "js/bing/chat/core.js"
}, {
    "revision": "bb997df34f49aaf3f82a2a9434e0a2d5",
    "url": "js/bing/chat/global.js"
}, {
    "revision": "1a0f8f43cc025b7b5995e885fed1a3e6",
    "url": "js/bing/chat/lib.js"
}, {
    "revision": "bf6c2f29aef95e09b1f72cf59f427a55",
    "url": "registerSW.js"
}, {
    "revision": "1da58864f14c1a8c28f8587d6dcbc5d0",
    "url": "img/logo.svg"
}, {
    "revision": "be40443731d9d4ead5e9b1f1a6070135",
    "url": "./img/pwa/logo-192.png"
}, {
    "revision": "1217f1c90acb9f231e3135fa44af7efc",
    "url": "./img/pwa/logo-512.png"
}, {
    "revision": "5e5048c8a928b9d4bd7d262e1f7a5976",
    "url": "manifest.webmanifest"
}]);
Re();
E(new Ee(be("./index.html")));
E(({request: s, url: e})=>s.destination === "style" || s.destination === "manifest" || s.destination === "script" || s.destination === "worker", new Ue({
    cacheName: `${Q}-assets`,
    plugins: [new q({
        statuses: [200]
    })]
}));
E(({request: s, url: e})=>e.pathname.includes("hm.gif") || e.pathname.includes("/fd/ls/") ? !1 : s.destination === "image", new De({
    cacheName: `${Q}-images`,
    plugins: [new q({
        statuses: [200]
    }), new Ve({
